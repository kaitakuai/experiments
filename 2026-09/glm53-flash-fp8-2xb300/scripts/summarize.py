...
1. **No honest floor here** — the August run collected one pass per seed, so there is no
   same-box repeat to measure it from. The floor for Blackwell comes from the 4xB200 folder.
